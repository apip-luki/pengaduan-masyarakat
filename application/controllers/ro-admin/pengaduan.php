...
class Pengaduan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('ro-admin/pengaduan/pengaduan_masuk', $data);
    ...
    public function tanggapan()
    {
        ...
        if (!$valid->run()) {
            ...
            $this->load->view('ro-admin/layout/sidebar', $data);
            $this->load->view('ro-admin/layout/topbar', $data);
            $this->load->view('ro-admin/pengaduan/pengaduan_detail', $data);
            $this->load->view('ro-admin/layout/footer', $data);
        } else {
            $data = [
            ...
            redirect('ro-admin/pengaduan/pengaduan_proses');
        }
    }
    ...
    public function pengaduan_proses()
    {
        ...
        $this->load->view('ro-admin/layout/sidebar', $data);
        $this->load->view('ro-admin/layout/topbar', $data);
        $this->load->view('ro-admin/pengaduan/pengaduan_proses', $data);
        $this->load->view('ro-admin/layout/footer', $data);
    }
    ...
    public function pengaduan_selesai()
    {
        ...
        $this->load->view('ro-admin/layout/sidebar', $data);
        $this->load->view('ro-admin/layout/topbar', $data);
        $this->load->view('ro-admin/pengaduan/pengaduan_selesai', $data);
        $this->load->view('ro-admin/layout/footer', $data);
    }
    ...
    public function generate_laporan()
    {
        if ($this->input->post('tgl_awal') == '') {
            ...
            $this->load->view('ro-admin/layout/sidebar', $data);
            $this->load->view('ro-admin/layout/topbar', $data);
            $this->load->view('ro-admin/laporan/generate', $data);
            $this->load->view('ro-admin/layout/footer', $data);
        } else {
            ...
            $this->load->view('ro-admin/layout/sidebar', $data);
            $this->load->view('ro-admin/layout/topbar', $data);
            $this->load->view('ro-admin/laporan/generate_laporan', $data);
            $this->load->view('ro-admin/layout/footer', $data);
        }
    }
